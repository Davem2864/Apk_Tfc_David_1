      			...
      			<div class="col-md-10">
      				...
      				if (isset($_POST['book'])) {
      				 	...
      				 	if (empty($sym)) {
      				 		...
      				 		$query="INSERT INTO appointment (firstname,surname,gender,phone,appointment_date,symptoms,statuts,date_booked) VALUES('$firstname','$surname','$gender','$phone','$date','$sym','Pending',NOW()) ";
      					...
      					<div class="row">
      						...
      						<div class="col-md-6 card bg-info">
      							<form method="post">
      								...
      								<textarea id="sym" name="sym" rows="4" cols="50" class="form-control" autocomplete="off" placeholder="your sumptoms here, keep it brief"></textarea>
